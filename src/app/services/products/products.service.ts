...
import { DeleteProductResponse } from 'src/models/interfaces/products/response/DeleteProductsResponse';
import { SaleProductResponse } from 'src/models/interfaces/products/response/SaleProductResponse';
